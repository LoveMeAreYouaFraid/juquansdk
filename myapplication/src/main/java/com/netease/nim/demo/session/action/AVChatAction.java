...
public class AVChatAction extends BaseAction {
    ...
    public AVChatAction(AVChatType avChatType) {//message_plus_audio_chat_selector
        super(avChatType == AVChatType.AUDIO ? R.drawable.message_plus_video_chat_selector : R.drawable.message_plus_video_chat_selector,
