 ...
 */
public class MsgViewHolderStickerCollection extends MsgViewHolderBase {

    private ImageView baseView;

    public MsgViewHolderStickerCollection(BaseMultiItemFetchLoadAdapter adapter) {
        super(adapter);
    }
    ...
    protected void bindContentView() {
        StickerCollectAttachment attachment = (StickerCollectAttachment) message.getAttachment();
        if (attachment == null) {
            return;
        }

        Glide.with(context)
                .load(attachment.emoji_link)
