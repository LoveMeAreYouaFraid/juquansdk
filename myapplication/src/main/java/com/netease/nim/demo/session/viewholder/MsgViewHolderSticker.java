...
public class MsgViewHolderSticker extends MsgViewHolderBase {
    ...
    protected void bindContentView() {
      ...
      //  System.out.println("---------attachment.getCatalog()="+attachment.getCatalog());
       // System.out.println("---------attachment.getChartlet()="+attachment.getChartlet());
        String imgurl=StickerManager.getInstance().getStickerUri(attachment.getCatalog(), attachment.getChartlet(),0);
      //  System.out.println("--------------2-收藏表情-imgurl="+imgurl);
        Glide.with(context)
                .load(imgurl)
