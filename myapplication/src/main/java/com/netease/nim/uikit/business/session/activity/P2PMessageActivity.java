...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    public static void start2(Context context, String contactId, SessionCustomization customization, IMMessage anchor,boolean isService) {
        Intent intent = new Intent();
    ...
    private void requestBuddyInfo() {
        setTextTitle(UserInfoHelper.getUserTitleName(sessionId, SessionTypeEnum.P2P));
    }
    ...
    protected MessageFragment fragment() {
        ...
        arguments.putBoolean("isService",getIntent().getBooleanExtra("isService",false));
    ...
    protected void initToolBar() {
        ...
        btn.setOnClickListener(view -> {
            Intent intent = new Intent(P2PMessageActivity.this, userInfoActivity);
            intent.putExtra("yx_id", sessionId);
    ...
    public static void setUserInfoActivity(Class<? extends Activity> clazz) {
        P2PMessageActivity.userInfoActivity = clazz;
    }
}
