...
public final class NimUIKitImpl {
    ...
    */
    ...
    public static void startP2PSession2(Context context, String account, IMMessage anchor,boolean isService) {
        NimUIKitImpl.startChatting2(context, account, SessionTypeEnum.P2P, commonP2PSessionCustomization, anchor,isService);
    }
    ...
    public static void startChatting2(Context context, String id, SessionTypeEnum sessionType, SessionCustomization
        ...
        if (sessionType == SessionTypeEnum.P2P) {
            P2PMessageActivity.start2(context, id, customization, anchor,isService);
        } else if (sessionType == SessionTypeEnum.Team) {
            TeamMessageActivity.start(context, id, customization, null, anchor);
        }
    }
    ...
    public static void startContactSelectorFragment(Context context, Fragment mFragment, ContactSelectActivity.Option option, int requestCode) {
        ContactSelectActivity.startActivityForResultFragment(context,mFragment, option, requestCode);
    }
