...
public class AdvancedTeamCreateAnnounceActivity extends UI {
    ...
    private void updateAnnounce() {
        ...
        updateGroupEvent.updateGroup(teamId, null, null, announcement, new EventInterface.ApiResponse<Object>() {
            @Override
            ...
            public void onFail(int type) {
                DialogMaker.dismissProgressDialog();
                toolbarView.setEnabled(true);
                ToastHelper.showToast(AdvancedTeamCreateAnnounceActivity.this, String.format(getString(R.string.update_failed), type));
            }
        });
    }
    ...
    public static void setUpdateGroupEvent(EventInterface.UpdateGroupEvent updateGroupEvent) {
        AdvancedTeamCreateAnnounceActivity.updateGroupEvent = updateGroupEvent;
    }
}
