...
import com.netease.nim.uikit.business.session.activity.VideoActivity;
...
public class VideoAction extends BaseAction {
    ...
    public VideoAction() {
        super(R.drawable.nim_message_plus_video_selector, R.string.input_panel_take);
    ...
    public void onClick() {
        ...
        VideoActivity.setListener((file, md5) -> {
        ...
        VideoActivity.setImageListener((file) -> {
