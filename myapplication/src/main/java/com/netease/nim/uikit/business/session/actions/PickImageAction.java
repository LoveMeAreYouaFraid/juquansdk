...
import static com.netease.nim.uikit.common.media.imagepicker.ImagePickerLauncher.selectImage;
import static com.netease.nim.uikit.common.media.imagepicker.ImagePickerLauncher.takePhoto;
...
public abstract class PickImageAction extends BaseAction {
    ...
    public void onClick() {
        ...
        if (isTakePhoto()) {
            takePhoto(getActivity(), requestCode);
        } else {
            ...
            selectImage(getActivity(), requestCode, option);
        }
    }

    protected abstract boolean isTakePhoto();
    ...
    private void showSelector(int titleId, final int requestCode, final boolean multiSelect) {
        ImagePickerOption option = DefaultImagePickerOption.getInstance().setShowCamera(true).setPickType(
                ImagePickerOption.PickType.Image).setMultiMode(multiSelect).setSelectMax(PICK_IMAGE_COUNT);
        selectImage(getActivity(), requestCode, option, titleId);
    }
